...
public interface Operation extends SubmodelElement {
     ...
     *
     * More information under https://admin-shell.io/aas/3/0/RC02/Operation/inoutputVariable
     *
     * @return Returns the List of OperationVariables for the property inoutputVariables.
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/Operation/inoutputVariable")
     ...
     *
     * More information under https://admin-shell.io/aas/3/0/RC02/Operation/inputVariable
     *
     * @return Returns the List of OperationVariables for the property inputVariables.
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/Operation/inputVariable")
     ...
     *
     * More information under https://admin-shell.io/aas/3/0/RC02/Operation/outputVariable
     *
     * @return Returns the List of OperationVariables for the property outputVariables.
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/Operation/outputVariable")
