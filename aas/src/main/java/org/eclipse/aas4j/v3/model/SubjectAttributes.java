...
public interface SubjectAttributes {
     ...
     *
     * More information under https://admin-shell.io/aas/3/0/RC02/SubjectAttributes/subjectAttribute
     *
     * @return Returns the List of DataElements for the property subjectAttributes.
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/SubjectAttributes/subjectAttribute")
