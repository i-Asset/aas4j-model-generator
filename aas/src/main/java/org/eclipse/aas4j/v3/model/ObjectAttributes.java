...
public interface ObjectAttributes {
     ...
     *
     * More information under https://admin-shell.io/aas/3/0/RC02/ObjectAttributes/objectAttribute
     *
     * @return Returns the List of References for the property objectAttributes.
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/ObjectAttributes/objectAttribute")
