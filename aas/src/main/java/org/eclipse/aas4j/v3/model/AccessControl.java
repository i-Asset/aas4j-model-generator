...
public interface AccessControl {
     ...
     *
     * More information under https://admin-shell.io/aas/3/0/RC02/AccessControl/accessPermissionRule
     *
     * @return Returns the List of AccessPermissionRules for the property accessPermissionRules.
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/AccessControl/accessPermissionRule")
     ...
     * https://admin-shell.io/aas/3/0/RC02/AccessControl/selectableSubjectAttributes
     *
     * @return Returns the Reference for the property selectableSubjectAttributes.
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/AccessControl/selectableSubjectAttributes")
     ...
     * are selectable by the access permission rules to assign permissions to the subjects.
     *
     * More information under https://admin-shell.io/aas/3/0/RC02/AccessControl/defaultSubjectAttributes
     *
     * @return Returns the Reference for the property defaultSubjectAttributes.
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/AccessControl/defaultSubjectAttributes")
     ...
     *
     * More information under https://admin-shell.io/aas/3/0/RC02/AccessControl/selectablePermissions
     *
     * @return Returns the Reference for the property selectablePermissions.
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/AccessControl/selectablePermissions")
     ...
     *
     * More information under https://admin-shell.io/aas/3/0/RC02/AccessControl/defaultPermissions
     *
     * @return Returns the Reference for the property defaultPermissions.
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/AccessControl/defaultPermissions")
     ...
     * rules defined for the AAS.
     *
     * More information under
     * https://admin-shell.io/aas/3/0/RC02/AccessControl/selectableEnvironmentAttributes
     *
     * @return Returns the Reference for the property selectableEnvironmentAttributes.
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/AccessControl/selectableEnvironmentAttributes")
     ...
     *
     * More information under
     * https://admin-shell.io/aas/3/0/RC02/AccessControl/defaultEnvironmentAttributes
     *
     * @return Returns the Reference for the property defaultEnvironmentAttributes.
     */
    @IRI("https://admin-shell.io/aas/3/0/RC02/AccessControl/defaultEnvironmentAttributes")
