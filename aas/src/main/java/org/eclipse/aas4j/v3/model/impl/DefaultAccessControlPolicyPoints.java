...
/**
 * Default implementation of package org.eclipse.aas4j.v3.model.AccessControlPolicyPoints
 * 
...
public class DefaultAccessControlPolicyPoints implements AccessControlPolicyPoints {
    ...
    protected AccessControl policyAdministrationPoint;
    ...
    @Override
    public AccessControl getPolicyAdministrationPoint() {
        return policyAdministrationPoint;
    }

    @Override
    public void setPolicyAdministrationPoint(AccessControl policyAdministrationPoint) {
