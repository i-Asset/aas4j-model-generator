...
public abstract class AssetAdministrationShellBuilder<T extends AssetAdministrationShell, B extends AssetAdministrationShellBuilder<T, B>>
    ...
    /**
     * This function allows setting a value for securitys
     * 
     * @param securitys desired value to be set
     * @return Builder object with new value for securitys
     */
    public B securitys(List<Security> securitys) {
        getBuildingInstance().setSecuritys(securitys);
        return getSelf();
    }

    /**
     * This function allows adding a value to the List securitys
     * 
     * @param security desired value to be added
     * @return Builder object with new value for securitys
     */
    public B security(Security security) {
        getBuildingInstance().getSecuritys().add(security);
        return getSelf();
    }
